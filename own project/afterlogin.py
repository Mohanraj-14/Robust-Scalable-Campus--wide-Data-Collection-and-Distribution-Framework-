    ...
    def search_data():
        ...
        try:
            ...
            if not fetched_data:
                ...
                search_window.destroy()  # Close search window after clicking OK
...
def add_participant():
    ...
    # Reduced size of the form_frame
    form_frame = Frame(add_window, bg='#FFFF00', bd=2, relief=RIDGE)
    form_frame.place(relx=0.01, rely=0.1, relwidth=0.5, relheight=0.8)  # Reduced to 60% width and height
